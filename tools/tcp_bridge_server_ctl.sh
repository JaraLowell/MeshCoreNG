...
TRANSPORT_RATE_LIMIT="${TCP_BRIDGE_TRANSPORT_RATE_LIMIT:-on}"
TRANSPORT_RATE_MAX="${TCP_BRIDGE_TRANSPORT_RATE_MAX:-20}"
TRANSPORT_RATE_WINDOW="${TCP_BRIDGE_TRANSPORT_RATE_WINDOW:-120}"
TRANSPORT_GLOBAL_RATE_MAX="${TCP_BRIDGE_TRANSPORT_GLOBAL_RATE_MAX:-80}"
TRANSPORT_GLOBAL_RATE_WINDOW="${TCP_BRIDGE_TRANSPORT_GLOBAL_RATE_WINDOW:-120}"
...
start_server() {
  ...
  local args=(
    ...
    --transport-rate-limit "${TRANSPORT_RATE_LIMIT}"
    --transport-rate-max "${TRANSPORT_RATE_MAX}"
    --transport-rate-window "${TRANSPORT_RATE_WINDOW}"
    --transport-global-rate-max "${TRANSPORT_GLOBAL_RATE_MAX}"
    --transport-global-rate-window "${TRANSPORT_GLOBAL_RATE_WINDOW}"
  )
...
Environment variables:
  ...
  TCP_BRIDGE_TRANSPORT_RATE_LIMIT default: on
  TCP_BRIDGE_TRANSPORT_RATE_MAX default: 20
  TCP_BRIDGE_TRANSPORT_RATE_WINDOW default: 120
  TCP_BRIDGE_TRANSPORT_GLOBAL_RATE_MAX default: 80
  TCP_BRIDGE_TRANSPORT_GLOBAL_RATE_WINDOW default: 120
